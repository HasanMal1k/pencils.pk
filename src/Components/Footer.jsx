...
function Footer() {
  return (
    <footer className="bg-[#FFFAFA] text-gray-600 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-4">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Pencils.pk</h2>
            <p className="text-sm">Your one-stop shop for all your stationery needs.</p>
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <h3 className="text-md font-semibold text-gray-800 mb-4">Contact Us</h3>
            <ul className="space-y-2 text-sm">
              <li>123 Stationery Street</li>
              <li>Karachi, Pakistan</li>
              <li>Phone: +92 123 456 7890</li>
              <li>Email: info@pencils.pk</li>
            </ul>
          </div>
          <div className="mb-4">
            <h3 className="text-md font-semibold text-gray-800 mb-4">Follow Us</h3>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Pencils.pk. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
